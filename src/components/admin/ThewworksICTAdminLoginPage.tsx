...
interface ThewworksICTAdminLoginPageProps {
  onAuthenticated?: () => void;
}

const ThewworksICTAdminLoginPage = ({ onAuthenticated }: ThewworksICTAdminLoginPageProps) => {
  ...
  const featurePills = [
    { label: 'Live print-order tracking', icon: <Box size={16} /> },
    { label: 'Protected admin access', icon: <ShieldCheck size={16} /> },
  ];

  return (
    <div className="admin-thewworksict flex min-h-screen w-full overflow-hidden font-store">
      <div className="admin-hero admin-grid relative hidden lg:flex lg:w-1/2 flex-col justify-between overflow-hidden p-12 text-white">
        ...
        <div className="relative z-10 max-w-xl">
          ...
          >
            <h2 className="mb-6 text-5xl font-bold leading-[1.02] text-white">
              Run the Thewworks back office with
            ...
            <p className="max-w-lg text-lg leading-relaxed text-white/72">
              ...
              service catalog, and manage the quote desk from one control room.
            </p>
          </motion.div>
        ...
        <div className="relative z-10">
          <p className="text-xs font-medium text-white/48">
            2026 Thewworks. All administrative actions are logged for security.
          </p>
        </div>
      </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="rounded-[1.5rem] border border-[color:var(--admin-stroke)] bg-white/80 p-5 shadow-[0_18px_40px_rgba(90,26,42,0.08)]">
              ...
              <p className="mt-3 text-sm font-semibold text-[var(--admin-burgundy)]">
                Approved account: stechnology309@gmail.com
              </p>
...
export default ThewworksICTAdminLoginPage;
