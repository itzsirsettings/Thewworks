...
interface StankingsAnalyticsDashboardProps {
  className?: string;
}

const StankingsAnalyticsDashboard = ({
  className = '',
}: StankingsAnalyticsDashboardProps) => {
      ...
      <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-sm leading-relaxed text-[var(--admin-muted)] md:text-base">
            A Stankings overview of conversion, demand, and revenue activity, framed with the
            same sand, burgundy, and orange palette used across the brand.
          </p>
        </div>
...
export default StankingsAnalyticsDashboard;
