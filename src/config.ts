...
export const heroConfig: HeroConfig = {
  ...
  rotatingTitles: [
    ...
    "Premier Printing Press in Asaba",
    "Custom Packaging & Branding",
    "Luxury Business Stationery",
    "High-Quality Books & Banners",
    "Nigeria's Best Print Partner",
    "Branded Apparel & Merchandise",
    "Large Format Printing Experts",
    "Creating Impressions That Last",
    "Perfectly Printed Every Time",
    "Print Smart. Brand Better.",
    "Reliable Prints. Faster Delivery.",
    "Excellence on Every Page",
    "Asaba's Trusted Branding Hub",
  ],
